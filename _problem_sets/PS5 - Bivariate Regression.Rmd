...
---
title: 'Problem Set: Bivariate Regression'
author: "Will Hopper"
output:
  html_document:
...
```{r}
hate_crimes <- read.csv("https://wjhopper.github.io/SSW-858/data/hate_crimes.csv", stringsAsFactors = FALSE)
```
...
## Exercise
Fit the regression model visualized in the previous question, and report the regression table. Based on this model, what hate crime rate would you expect to occur in a state with a GINI index of 50? What hate crime rate would you expect in state with a GINI index of 0?
...
## Exercise
Fit the regression model that explains variation in the rate of hate crimes using median household income category, and report the regression table. Based on this regression model, what is:
