...
---
title: 'Problem Set: Data Visualization'
...
For this problem set, you'll continue working with the `ncbirths` data set. Just as we've done in lecture, you can import this data into R using the following code:
...
## Exercise
Explore the data using the `glimpse` function e.g., `glimpse(ncbirths)`. 

a. Explain what you can learn from the output of this function.
b. How can you tell which variables are likely categorical, and which are likely to be numeric, based on the output of the `glimpse` function.
...
**Hint:** If you're not sure, try creating histograms with binwidths of 80 and 0.5, and see what the problems are.
