...
2. Select every third month of the year from this vector, beggining with January.
...
## Exercise
Find the median number of homes sold per month in each city for each year.
